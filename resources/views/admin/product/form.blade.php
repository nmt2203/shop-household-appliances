        ...
        <div class="box box-warning">
            ...
            <div class="box-body block-images">
                <div style="margin-bottom: 10px">
                    <img  src="{{url('/')}}//uploads/brand/{{$product->picture}}" class="img-thumbnail" onerror="this.onerror=null;this.src='{{asset('/images/no-image.jpg')}}" alt="" style="width:200px; height:200px">
                </div>
