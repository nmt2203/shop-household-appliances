...
@section('content')
 ...
 <section class="hero hero-normal">
    ...
    <section class="blog-details-hero set-bg" data-setbg="{{asset('/fontend/img/breadcrumb.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="order-md-1 order-1">
                <div class="blog__details__text" style="text-align: center">
                    <img src="{{url('/')}}//uploads/brand/{{$article->picture}}" alt="" >
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="blog__item">
                            <div class="blog__item__pic" style="height: 258px">
                                <img src="{{url('/')}}//uploads/brand/{{$item->picture}}" alt="" style="height: 100%">
                            </div>
